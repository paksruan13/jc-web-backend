...
export default function Nav({show}){
    ...
    const activeLink = inactiveLink + ' bg-highlight text-black rounded-md font-bold';
    ...
    return(
        <aside className={(show?'left-0':'-left-full') + " top-0 text-gray-500 p-4 fixed w-full bg-bgTeal h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-3">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={pathname.includes('/services') ? activeIcon : inactiveIcon}>
